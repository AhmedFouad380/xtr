...
@php
    $route = 'delivery_services';
@endphp
@section('title',__('lang.delivery_services'))
@section('header')
    <!--begin::Heading-->
...
{{--                            </th>--}}
                            ...
                            <th class="min-w-125px">{{__('lang.commission')}}</th>
                            <th class="min-w-125px">{{__('lang.min_cost')}}</th>
        ...
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'commission', name: 'commission', "searchable": true, "orderable": true},
                    {data: 'min_cost', name: 'min_cost', "searchable": false, "orderable": false},
