                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="users_table">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">{{__('lang.count')}}</th>
                            <th class="min-w-125px">{{__('lang.used_count')}}</th>
                            <th class="min-w-125px">{{__('lang.expire_date')}}</th>
        ...
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'used_count', name: 'used_count', "searchable": true, "orderable": true},
