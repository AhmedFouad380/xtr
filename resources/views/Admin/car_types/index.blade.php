                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="users_table">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">{{__('lang.start_price')}}</th>
                            <th class="min-w-125px">{{__('lang.prices')}}</th>
        ...
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'start_price', name: 'start_price', "searchable": false, "orderable": false},
                    {data: 'btn_prices', name: 'btn_prices', "searchable": false, "orderable": false},
