...
<div class="fv-row mb-7">
    <!--begin::Label-->
    <label class="required fw-bold fs-6 mb-2">{{__('lang.start_price')}}</label>
    <!--end::Label-->
    <!--begin::Input-->
    <input type="number" name="start_price" step="any" @if(app()->getLocale() == 'ar') style="direction: rtl;" @endif
    class="form-control form-control-solid mb-3 mb-lg-0" value="{{old('start_price',$data->start_price ?? '')}}" required/>
    <!--end::Input-->
</div>
