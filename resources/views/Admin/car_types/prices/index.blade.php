...
@php
    $route = 'car_types';
@endphp
@section('title',__('lang.car_types'))
@section('header')
    <!--begin::Heading-->
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="users_table">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">{{__('lang.from')}}</th>
                            <th class="min-w-125px">{{__('lang.to')}}</th>
                            <th class="min-w-125px">{{__('lang.price_per_km')}}</th>
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                ajax: {
                    url: '{{ route($route.'.prices.datatable',['id'=>$id]) }}',
                    data: {
                        'id':{{$id}}
                    }
                },
                columns: [
                    ...
                    {data: 'from', name: 'from', "searchable": true, "orderable": true},
                    {data: 'to', name: 'to', "searchable": true, "orderable": true},
                    {data: 'price_per_km', name: 'price_per_km', "searchable": true, "orderable": true},
                    {data: 'actions', name: 'actions', "searchable": false, "orderable": false},
                ]
            });
            $.ajax({
                url: "{{ route($route.'.prices.table_buttons',$id) }}",
