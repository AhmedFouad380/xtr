...
@section('header')
    ...
    <ul class="breadcrumb fw-bold fs-base my-1">
        ...
        <li class="breadcrumb-item">
            ...
            <li class="breadcrumb-item">
                <a href="{{route($route.'.show',$data->car_type_id)}}" class="text-muted">
                    {{trans('lang.prices')}} </a>
            </li>
        ...
        <div class="content flex-row-fluid" id="kt_content">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <!--begin::Form-->
                    <form id="kt_account_profile_details_form" action="{{route('prices.update',$data->id)}}"
                          class="form"
                    ...
                    <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                            <!--begin::Input group-->
                            @include('Admin.'.$route.'.prices.form')
                        </div>
                        <!--end::Scroll-->
                        <!--begin::Actions-->
