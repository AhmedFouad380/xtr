    ...
    <div class="card-body pt-0">
        ...
        <table class="table align-middle table-row-dashed fs-4 gy-5" id="users_table">
            ...
            <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                <th class="min-w-125px text-center">{{__('lang.type')}}</th>
                <th class="min-w-125px text-center">{{__('lang.default_wallet')}}</th>
                <th class="min-w-125px text-center">{{__('lang.price')}}</th>
                <th class="min-w-125px text-center">{{__('lang.description')}}</th>
                <th class="min-w-125px text-center">{{__('lang.order')}}</th>
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('providers.wallet_transactions.datatable',$data->id) }}',
                    data: {}
                },
                columns: [

                    {data: 'type', name: 'type', "searchable": true, "orderable": true},
                    {data: 'default_wallet', name: 'default_wallet', "searchable": true, "orderable": true},
