...
@php
    $route = 'limousine_orders';
@endphp
@section('title',__('lang.limousine_orders'))
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="users_table">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">{{__('lang.car_type')}}</th>
        ...
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'car_type', name: 'car_type', "searchable": true, "orderable": true},
